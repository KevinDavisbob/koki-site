...
Classmates often ask: where do I start with security? Here's my answer as a six-stage map — the full version of the [Security Zone](/en/security) beginner guide. Save it, and come back when you feel lost.
...
- **Find the fun**: play this site's [6-level CTF challenge](/en/challenge) and feel the joy of finding hidden things
...
The full version lives in the [Security Zone](/en/security) — with a progress checklist to carry you all the way to the grave 🏆
